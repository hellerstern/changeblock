      ...
      {(() => {
        if (selectedTab === "WhatIf") {
              ...
              <div className="row">
                <div className="col-6">
                  <ChartBox
                    ...
                    subheading={"Select from list or pick at random"}
                    children={
                      <SelectIndex
                  ...
                  <ChartBox
                    ...
                    children={
                      <ContributionTable summary={contributionSummary} />
                    }
                  />
                  <ChartBox
                    heading={"Summary of Output"}
                    subheading={"Outcome of each feature prediction"}
                    children={
                      loadingFeatureSummary ? (
                        <div className="d-flex justify-content-center flex-column p-3 text-center">
                          ...
                          >
                            <strong>Summarising Prediction</strong>
                          </p>
                          <div
                            style={{
                          ...
                          >
                            We are currently generating your summary This can
                            take up to a minute
                          </p>
                        </div>
                ...
                <div className="col-6">
                  <div className={scrollPosition > 472 ? styles.fixed : ""}>
                    <ChartBox
                      heading={"Prediction"}
                      children={
                        <Prediction
          ...
          return (
            <div>
              <div className="d-flex justify-content-between">
                <h3 className={`${styles.heading}`}>Aspect Based Sentiment</h3>

                {/* <select>
                                    <option value={"Download"}>Download</option>
                                </select> */}
              </div>
              <p>Upload a document to get Aspect Based Sentiment </p>
                  ...
                  <div className="col-7 text-center">
                    <div className={styles.info_box}>
                      <img
                        ...
                        className="img-fluid"
                      />
                      <p>Upload document to get Aspect Based Sentiment</p>
                    </div>
                  </div>
                </div>
              ) : (
